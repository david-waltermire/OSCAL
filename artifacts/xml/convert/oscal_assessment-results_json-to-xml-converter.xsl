...
<!-- JSON to XML conversion: pipeline -->
   ...
   <xsl:template match="j:map[@key='assessment-results']/j:map[@key='metadata']/j:array[@key='revisionsx']/j:array[@key='revisionsx']/j:map"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="assessment-results/metadata/revisionsx/revision" -->
   ...
   <xsl:template match="j:map[@key='assessment-results']/j:map[@key='metadata']/j:array[@key='revisionsx']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="assessment-results/metadata/revisionsx" -->
   ...
   <xsl:template match="j:map[@key='assessment-results']/j:map[@key='metadata']/j:array[@key='revisionsx']/j:array[@key='revisionsx']/j:map/j:string[@key='title']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="assessment-results/metadata/revisionsx/revision/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
             formal-name="Document Title"
   ...
   <xsl:template match="j:map[@key='assessment-results']/j:map[@key='metadata']/j:array[@key='revisionsx']/j:array[@key='revisionsx']/j:map/j:string[@key='published']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="assessment-results/metadata/revisionsx/revision/published" -->
      <field name="oscal-metadata-published"
             gi="published"
             as-type="dateTime-with-timezone"
             formal-name="Publication Timestamp"
   ...
   <xsl:template match="j:map[@key='assessment-results']/j:map[@key='metadata']/j:array[@key='revisionsx']/j:array[@key='revisionsx']/j:map/j:string[@key='last-modified']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="assessment-results/metadata/revisionsx/revision/last-modified" -->
      <field name="oscal-metadata-last-modified"
             gi="last-modified"
             as-type="dateTime-with-timezone"
             formal-name="Last Modified Timestamp"
   ...
   <xsl:template match="j:map[@key='assessment-results']/j:map[@key='metadata']/j:array[@key='revisionsx']/j:array[@key='revisionsx']/j:map/j:string[@key='version']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="assessment-results/metadata/revisionsx/revision/version" -->
      <field name="oscal-metadata-version"
             gi="version"
             formal-name="Document Version"
             in-json="SCALAR">
   ...
   <xsl:template match="j:map[@key='assessment-results']/j:map[@key='metadata']/j:array[@key='revisionsx']/j:array[@key='revisionsx']/j:map/j:string[@key='oscal-version']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="assessment-results/metadata/revisionsx/revision/oscal-version" -->
      <field name="oscal-metadata-oscal-version"
             gi="oscal-version"
             formal-name="OSCAL version"
             in-json="SCALAR">
   ...
   <xsl:template match="j:map[@key='assessment-results']/j:map[@key='metadata']/j:array[@key='revisionsx']/j:array[@key='revisionsx']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- XML match="assessment-results/metadata/revisionsx/revision/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
